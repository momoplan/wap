...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a 
		   href="/w/wap/11select5/optionSeven.jspx">自选</a>|<a 
		   href="/w/wap/11select5/optionSevenAutoDS.jspx">单式机选</a>|复式机选<br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
		<form action="/wap/11select5/optionSevenAutoFS.jspx" method="post">
