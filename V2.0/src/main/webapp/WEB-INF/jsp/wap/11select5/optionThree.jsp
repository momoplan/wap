...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/11select5/optionOne.jspx">一</a>|<a href="/wap/11select5/optionTwo.jspx">二</a>|三|<a href="/wap/11select5/optionFour.jspx">四</a>|<a href="/wap/11select5/optionFive.jspx">五</a>|<a href="/wap/11select5/optionSix.jspx">六</a>|<a href="/wap/11select5/optionSeven.jspx">七</a>|<a href="/wap/11select5/optionEight.jspx">八</a><br/>
		自选|<a 
		   href="/w/wap/11select5/optionThreeAutoDS.jspx">单式机选</a>|<a 
		   href="/w/wap/11select5/optionThreeAutoFS.jspx">复式机选</a><br/>
		<%
		...
		%> <%
 		...
 		<form action="/wap/11select5/optionThree.jspx" method="post">
		...
		%></a>
 		01-11选3-4个数字,号码间无分隔,数字不可重复,小于10则补0,如选择2则填写02<br/>
 		自选<br/>
 		<form action="/11select5/optionByHand.jspx" method="post">
 		注码：<input name="zhuma" type="text" emptyok="true"  size="20" maxlength="8" format="*N" tabindex="1" value="<%=zhuma %>" /><br/>
