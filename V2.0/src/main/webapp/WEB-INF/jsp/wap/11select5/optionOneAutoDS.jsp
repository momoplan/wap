...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a 
		   href="/w/wap/11select5/optionOne.jspx">自选</a>|单式机选|<a 
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/11select5/optionOneAutoDS.jspx" method="post">
		...
		机选:<input name="optionDS" type="text" emptyok="true"  size="2" maxlength="2" format="*N" tabindex="1" value="<%=optionDS %>" />注(最多99注)<br/>
