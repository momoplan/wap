...
<c:if test="${not empty listMap }">
	<form action="<%=request.getContextPath() %>/jc/jczqBetDetail.jspx" method="post">
	...
	<c:if test="${changci >4 && lotno != 'FT002' && lotno != 'FT004'}">
			<input type="checkbox" name="wanfa"
			value="505" id="" /><span>5串1 </span>
	</c:if>
	<c:if test="${changci >5 && lotno != 'FT002' && lotno != 'FT004'}">
			<input type="checkbox" name="wanfa"
			value="506" id="" /><span>6串1 </span>
	</c:if>
	<c:if test="${changci >6 && lotno != 'FT002' && lotno != 'FT003' && lotno != 'FT004'}">
			<input type="checkbox" name="wanfa"
			value="507" id="" /><span>7串1 </span><br/>
	</c:if>
	<c:if test="${changci >7 && lotno != 'FT002' && lotno != 'FT003' && lotno != 'FT004'}">
			<input type="checkbox" name="wanfa"
