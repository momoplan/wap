...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		前一数投|<a 
		 ...
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneNumberSelf.jspx">自选</a>|单式机选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneNumberMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectOneNumberSingleAuto.jspx" method="post">
	...
	前一数投：投注号码与开奖号第一位数字相同一致，奖金25元<br/>	
		【最新开奖】<br/>	
