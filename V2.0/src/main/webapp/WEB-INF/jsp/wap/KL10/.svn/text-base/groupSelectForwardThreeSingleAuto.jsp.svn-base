...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectTwoLinkGroupSelf.jspx">选二连组</a>|前三组选<br/>
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/groupSelectForwardThreeSelf.jspx">自选</a>|单式机选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/groupSelectForwardThreeMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/groupSelectForwardThreeSingleAuto.jspx" method="post">
	...
	<form action="/guangDongHappyTenMinutes/optionSingleAutoDetail.jspx" method="post">
	机选: <input type="text" name="zhuShu"  maxlength="2" size="2" value="${zhuShu }">注(最多99注)<br/>
	...
	前三组选：投注号码与开奖号前3位号码一致，奖金1300元<br/>	
		【最新开奖】<br/>	
