...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		   href="/w/guangDongHappyTenMinutesIndex/optionTwoDanTuoSelf.jspx">任二</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/optionThreeDanTuoSelf.jspx">任三</a>|<a 
		   ...
		   href="/w/guangDongHappyTenMinutesIndex/groupSelectForwardThreeDanTuoSelf.jspx">前三组选</a>|选二连直|<a 
		   href="/w/guangDongHappyTenMinutesIndex/directSelectForwardThreeDanTuoSelf.jspx">前三直选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectTwoLinkDirectDanTuoSelf.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
		  
 	从1~20选择，胆码1个，胆码+拖码注码个数≥3，号码间无分隔符,10之前号码前面补0,如1要输入01<br/>
	...
	胆码: <input type="text" name="danMa"  maxlength="2" size="20" value="${danMa }"><br/>
	...
	选二连直胆拖：投注号码按顺序与开奖号连续2位号码一致，奖金62元<br/>	
		【最新开奖】<br/>	
