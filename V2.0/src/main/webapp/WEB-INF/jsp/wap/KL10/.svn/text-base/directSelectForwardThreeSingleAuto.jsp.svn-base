...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		 ...
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/directSelectForwardThreeSelf.jspx">自选</a>|单式机选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/directSelectForwardThreeMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/directSelectForwardThreeSingleAuto.jspx" method="post">
