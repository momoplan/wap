...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		   ...
		   href="/w/guangDongHappyTenMinutesIndex/optionFourDanTuoSelf.jspx">任四</a>|任五|<a 
		 ...
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/optionFiveDanTuoSelf.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
		  
 	从1~20选择，胆码1-4个，胆码+拖码注码个数≥6，号码间无分隔符,10之前号码前面补0,如1要输入01<br/>
	...
	胆码: <input type="text" name="danMa"  maxlength="8" size="20" value="${danMa }"><br/>
	...
	任五胆拖：投注号码与开奖号任意5个号码一致，奖金320元<br/>	
		【最新开奖】<br/>	
