...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		 ...
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/optionTwoSelf.jspx">自选</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/optionTwoSingleAuto.jspx">单式机选</a>|复式机选<br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/optionTwoMultipleAuto.jspx" method="post">
