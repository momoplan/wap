...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		 ...
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/directSelectForwardThreeSelf.jspx">自选</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/directSelectForwardThreeSingleAuto.jspx">单式机选</a>|复式机选<br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/directSelectForwardThreeMultipleAuto.jspx" method="post">
	...
	<form action="/guangDongHappyTenMinutes/directSelectForwardThreeMultipleAutoDetail.jspx" method="post">
	...
	三位: <input type="text" name="third"  maxlength="2" size="2" value="${third }">个(最多20个)<br/>
	...
	前三直选：投注号码按顺序与开奖号前3位号码一致，奖金8000元<br/>	<br/>	
		【最新开奖】<br/>	
