 ...
 <%  ResourceBundle rbint = ResourceBundle.getBundle("jrtWAPSite");
  ...
  //刷新页面截至日期
    ...
    %>
		...
		<a href="/w/wap/cqshishicai/sscThreeStar.jspx">自选</a>|机选<br/>
	<%
	...
	%>
		<%if (deadline!=null) { %>
		 ...
		 <form action="/wap/cqshishicai/sscThreeStarAuto.jspx" method="post" style="margin:0px;display:inline;">
		...
		%></a>
		<form action="/shishicaiauto/autoThree.jspx" method="post">
