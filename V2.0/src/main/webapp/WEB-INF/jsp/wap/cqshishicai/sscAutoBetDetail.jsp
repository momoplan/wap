...
<body>
		...
		您的投注:<br/>
			...
			<form action="/shishicaiauto/SSCAutoBet.jspa" method="post" style="margin:0px;display:inline;">
			...
			<%String act ="/shishicaiauto/"+ autoMethod+".jspx" ;%>
			<form action="<%=act %>" method="post" style="margin:0px;display:inline;">
				<input type="hidden" name="jixuan" value="<%=zhushu%>"/>
				<input type="hidden" name="beishu" value="<%=beishu %>" />
				<input type="hidden" name="addNumber" value="<%=addNumber %>" />
				<input type="submit" value="重新机选" />			
			</form>
			<br/>
			【最新开奖】<br/>
		 <% 
