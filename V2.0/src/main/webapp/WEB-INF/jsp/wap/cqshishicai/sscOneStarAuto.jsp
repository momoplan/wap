...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		一星|<a 
		   ...
		   <a 
		   href="/wap/cqshishicai/sscOneStar.jspx">自选</a>|机选<br/>
	...
	%>
		<%if (deadline!=null) { %>
		 ...
		 <form action="/wap/cqshishicai/sscOneStarAuto.jspx" method="post" style="margin:0px;display:inline;">
		...
		%></a>
		<form action="/shishicaiauto/SSCOneStarAuto.jspx" method="post">
		机选:<input name="jixuan" type="text" emptyok="true" maxlength="2" size="2" format="*N" tabindex="1" value="<%=jixuan %>"/>注（1-10注）<br/>
