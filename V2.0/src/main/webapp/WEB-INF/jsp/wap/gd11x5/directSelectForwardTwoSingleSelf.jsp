...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		...
		${headLine }
 		<form action="/guangDongElevenSelectFiveIndex/directSelectForwardTwoSingleSelf.jspx" method="post">
	...
	<c:if test="${not empty messageError }">
 		...
 		<form action="/guangDongElevenSelectFive/directSelectForwardTwoSingleSelfDetail.jspx" method="post">
