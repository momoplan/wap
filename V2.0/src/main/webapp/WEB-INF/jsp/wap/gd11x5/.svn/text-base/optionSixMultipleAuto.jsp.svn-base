...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		...
		<a 
		   ...
		   href="/w/guangDongElevenSelectFiveIndex/optionFiveSelf.jspx">五</a>|六|<a 
		 ...
		 <a 
		   href="/w/guangDongElevenSelectFiveIndex/optionSixSelf.jspx">自选</a>|<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionSixSingleAuto.jspx">单式机选</a>|复式机选<br/>
		${headLine }
 		<form action="/guangDongElevenSelectFiveIndex/optionSixMultipleAuto.jspx" method="post">
	...
	<c:if test="${not empty messageError }">
		...
		机选: <input name="geShu" type="text"  size="10" maxlength="2"  tabindex="1" value="${geShu }" />个(6-11)<br/>
