...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		...
		选前二：<a 
		   href="/w/guangDongElevenSelectFiveIndex/directSelectForwardTwoSingleSelf.jspx">直选单式</a>|<a 
			href="/w/guangDongElevenSelectFiveIndex/directSelectForwardTwoMultipleSelf.jspx">直选复式</a>|<a 
			href="/w/guangDongElevenSelectFiveIndex/directSelectForwardTwoPositionMultipleSelf.jspx">直选定位复式</a><br/>
		选前三：<a href="/w/guangDongElevenSelectFiveIndex/directSelectForwardThreeSingleSelf.jspx">直选单式</a>|直选复式|<a 
		href="/w/guangDongElevenSelectFiveIndex/directSelectForwardThreePositionMultipleSelf.jspx">直选定位复式</a> <br/>
		${headLine }
 		<form action="/guangDongElevenSelectFiveIndex/directSelectForwardThreeMultipleSelf.jspx" method="post">
	...
	<c:if test="${not empty messageError }">
 		...
 		<form action="/guangDongElevenSelectFive/directSelectForwardThreeMultipleSelfDetail.jspx" method="post">
