...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		...
		<a 
		   ...
		   href="/w/guangDongElevenSelectFiveIndex/optionSixSelf.jspx">六</a>|七|<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionEightSelf.jspx">八</a><br/>
		 <a 
		   href="/w/guangDongElevenSelectFiveIndex/optionSevenSelf.jspx">自选</a>|<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionSevenSingleAuto.jspx">单式机选</a>|复式机选<br/>
		${headLine }
 		<form action="/guangDongElevenSelectFiveIndex/optionSevenMultipleAuto.jspx" method="post">
	...
	<c:if test="${not empty messageError }">
		...
		机选: <input name="geShu" type="text"  size="10" maxlength="2"  tabindex="1" value="${geShu }" />个(7-11)<br/>
