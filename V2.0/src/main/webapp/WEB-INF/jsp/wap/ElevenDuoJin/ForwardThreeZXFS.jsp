...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		选前三：<a href="/wap/ElevenDuoJin/ForwardThreeZX.jspx">直选单式</a>|直选复式|<a 
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/ElevenDuoJin/ForwardThreeZXFS.jspx" method="post">
	...
	<span style="color: red;">   提示： <%out.println(message); %><br/></span>
		<%} %>
 		选前三直选复式<br/>
 		<form action="/elevenduojin/groupFSDetailZ3.jspx" method="post">
 		...
 		<input type="hidden" name="type" value="z3fs" />
