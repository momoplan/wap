...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/ElevenDuoJin/optionOne.jspx">任一</a>|<a 
		   ...
		   自选|<a 
		   href="/w/wap/ElevenDuoJin/optionSixAutoDS.jspx">单式机选</a>|<a 
		   href="/w/wap/ElevenDuoJin/optionSixAutoFS.jspx">复式机选</a><br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/ElevenDuoJin/optionSix.jspx" method="post">
