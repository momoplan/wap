...
%> </a> <%
 ...
 <a href="/wap/ElevenDuoJin/dantuoR2.jspx">任二</a>|<a 
 	...
 	href="/wap/ElevenDuoJin/dantuoR6.jspx">任六</a>|任七|<a 
 ...
 %> <form action="/wap/ElevenDuoJin/dantuoR7.jspx"
	method="post">
<input type="submit" value="刷新" /> </form><br />
胆码限选1-6个,拖码2~10，不与胆码重复,至少选择2注<br />
<%if(message != null){ %>
		<span style="color: red;">   提示： <%out.println(message); %><br/></span>
	 <%} %>
<form	action="/elevenduojin/todantuoDetail.jspx"	method="post"> 
           胆码:<input name="danma" type="text"  size="20" maxlength="12"  value="<%=danma%>" /><br /> 
	拖码:<input name="tuoma" type="text"   size="20" maxlength="20"  value="<%=tuoma %>" /><br /> 
	倍数:<input name="beishu" type="text"  maxlength="2" maxlength="11" size="2" value="<%=beishu %>" />(最多99倍)<br /> 
           追号:<input name="addnumber" type="text"  maxlength="2"	size="2"  value="<%=addnumber%>" />期<br />(最高99期,默认追1期,即买当前期)<br />
    <input	type="hidden" name="type" value="DR7" />
