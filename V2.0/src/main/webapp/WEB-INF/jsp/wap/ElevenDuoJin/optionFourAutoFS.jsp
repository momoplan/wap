...
String autoFScode = (String) request.getAttribute("autoFScode");if(autoFScode == null) autoFScode = "4";
    
%>
	<title>十一运夺金任选四</title>
<body>
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/ElevenDuoJin/optionOne.jspx">任一</a>|<a 
		   ...
		   href="/wap/ElevenDuoJin/optionThree.jspx" >任三</a>|任四|<a 
		   ...
		   <a 
		   href="/w/wap/ElevenDuoJin/optionFour.jspx">自选</a>|<a 
		   href="/w/wap/ElevenDuoJin/optionFourAutoDS.jspx">单式机选</a>|复式机选<br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/ElevenDuoJin/optionFourAutoFS.jspx" method="post">
...
<span style="color: red;">   提示： <%out.println(message); %><br/></span>
 <%} %>
		...
		机选:<input name="autoFScode" type="text"  size="10" maxlength="2"  tabindex="1" value="<%=autoFScode %>" />个(4-11)<br/>
		...
		<input type="hidden" name="type" value="autoR4" />
