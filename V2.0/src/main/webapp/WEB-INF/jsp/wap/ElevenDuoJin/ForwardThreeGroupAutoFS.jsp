...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a 
		   href="/w/wap/ElevenDuoJin/ForwardThreeGroup.jspx">自选</a>|<a 
		   href="/w/wap/ElevenDuoJin/ForwardThreeGroupAutoDS.jspx">单式机选</a>|复式机选<br/>
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/ElevenDuoJin/ForwardThreeGroupAutoFS.jspx" method="post">
