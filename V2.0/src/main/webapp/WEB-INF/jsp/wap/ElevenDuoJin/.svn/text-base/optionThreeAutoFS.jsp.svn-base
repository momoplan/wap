...
String autoFScode = (String) request.getAttribute("autoFScode");if(autoFScode == null) autoFScode = "3";
 
%>
	<title>十一运夺金任选三</title>
<body>
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/ElevenDuoJin/optionOne.jspx">任一</a>|<a 
		   href="/wap/ElevenDuoJin/optionTwo.jspx">任二</a>|任三|<a 
		   ...
		   <a 
		   href= "/w/wap/ElevenDuoJin/optionThree.jspx">自选</a>|<a 
		   href="/w/wap/ElevenDuoJin/optionThreeAutoDS.jspx">单式机选</a>|复式机选<br/>
		<%
		...
		%> <%
 		...
 		<form action="/wap/ElevenDuoJin/optionThreeAutoFS.jspx" method="post">
...
<span style="color: red;"> 提示： <%out.println(message); %><br/></span>
 <%} %>
		...
		机选:<input name="autoFScode" type="text"  size="10" maxlength="2"  tabindex="1" value="<%=autoFScode %>" />个(3-11)<br/>
		...
		<input type="hidden" name="type" value="autoR3" />
