...
if(addnumber==null || "".equals(addnumber)||"newaddnumbernull".equals(newaddnumbernull)){
	...
	listAdd = new AddNumberUtil().getAddAmtByParam(beishuarr, zhushu, add+"",flag);
}else if(addnumberError!=null&&!"".equals(addnumberError)){
...
<a href="/w/add/toAddNumberBet.jspx?flag=rx1">任一</a>|任二|<a 
   href="/w/add/toAddNumberBet.jspx?flag=rx3">任三</a>|<a 
   href="/w/add/toAddNumberBet.jspx?flag=rx4">任四</a>|<a 
