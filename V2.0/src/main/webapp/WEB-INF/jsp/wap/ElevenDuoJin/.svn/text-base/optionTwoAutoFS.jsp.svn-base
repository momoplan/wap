...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/ElevenDuoJin/optionOne.jspx">任一</a>|任二|<a 
		   ...
		   <a 
		   href= "/w/wap/ElevenDuoJin/optionTwo.jspx">自选</a>|<a 
		   href="/w/wap/ElevenDuoJin/optionTwoAutoDS.jspx">单式机选</a>|复式机选<br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/ElevenDuoJin/optionTwoAutoFS.jspx" method="post">
 ...
 <%} %>
		...
		<input type="hidden" name="type" value="autoR2" />
