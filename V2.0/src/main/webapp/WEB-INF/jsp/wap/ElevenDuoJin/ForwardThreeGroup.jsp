...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		自选|<a 
		   href="/w/wap/ElevenDuoJin/ForwardThreeGroupAutoDS.jspx">单式机选</a>|<a 
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/ElevenDuoJin/ForwardThreeGroup.jspx" method="post">
		...
		<span style="color: red;">   提示： <%out.println(message); %><br/></span>
		 <%} %>
 		前三组选自选<br/>
 		<form action="/elevenduojin/DetailBetG3.jspx" method="post">
