...
String autoFScode = (String) request.getAttribute("autoFScode");if(autoFScode == null) autoFScode = "7";

%>
	<title>十一运夺金任选七</title>
<body>
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/ElevenDuoJin/optionOne.jspx">任一</a>|<a 
		   ...
		   href="/wap/ElevenDuoJin/optionSix.jspx" >任六</a>|任七|<a 
		   href="/wap/ElevenDuoJin/optionEight.jspx">任八</a><br/>
		   <a 
		   href= "/w/wap/ElevenDuoJin/optionSeven.jspx">自选</a>|<a 
		   href="/w/wap/ElevenDuoJin/optionSevenAutoDS.jspx">单式机选</a>|复式机选<br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
		<form action="/wap/ElevenDuoJin/optionSevenAutoFS.jspx" method="post">
 ...
 <%} %>
		...
		机选:<input name="autoFScode" type="text"  size="10" maxlength="2"  tabindex="1" value="<%=autoFScode %>" />个(7-11)<br/>
		...
		<input type="hidden" name="type" value="autoR7" />
