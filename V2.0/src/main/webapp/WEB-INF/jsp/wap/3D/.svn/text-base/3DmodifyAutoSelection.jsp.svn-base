...
%>福彩3D<%
 ...
 %>注码修改<br />
	...
	%>
	<form action="/single3D/modifyBetDetail.jspx" method="post" style="margin:0px;display:inline;">
	...
	%> <%
		...
		for(int i=0;i<s.length;i++){
			xgzhuma = s[i];
	%>
		<input name="i<%=i%>" type="text" emptyok="true"  size="8" maxlength="8" format="*N" tabindex="1" value="<%=xgzhuma%>"/><br/>
	<%	
		}
	%>
