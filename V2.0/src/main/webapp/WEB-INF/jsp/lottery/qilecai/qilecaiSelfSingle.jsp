...
<div class="main" >
	...
	<div class="touzhuCon">
		...
		<div class="touzhunav">
			<ul>
				<li class="navover"><a href="/w/handpay/lotteryQiLeCaiSelfSingle.jspa">单式自选</a></li>
	...
	<div class="touzhutext">
			<p>
				${deadline }<br />
				(数字1-30任选7个，号码间无空格，小于10则补0.如02061320.)</p>
			<form action="/w/handpay/lotteryQiLeCaiSelfSingleBetDetail.jspa" method="post">
			<p>
			<span>填写号码:
			<input name="zhuma" type="text" class="inputsmall" value="${zhuma }"/>
			(如:010203040509) </span><br />
			...
			(最高99期,默认追1期,即买当前期)			
			<input name="type" type="hidden" value="QiLeCaiSelfSingle"/>
			</p>
			<p class="tijiao"><input type="hidden" value="提交投注"/> </p>
			</form>
  </div>
	</div>
</body>