...
<div class="main" >
	...
	<div class="touzhuCon">
		...
		<div class="touzhunav">
			<ul>
				...
				<li class="navover"><a href="/w/handpay/lottery3DMultiple.jspa">复式投注</a></li>
	...
	<div class="touzhutext">
			<p>
				${deadline}<br />
				组选:<select name="type" class="selectsmall"><option selected="selected" value="3DGroup3Direct">组三</option></select><br />（数字0-9,选2个或以上,号码不能重复）
			</p>
			<form action="/w/handpay/lottery3DMultipleBetDetail.jspa" method="post">
			<p>
			<span>数字:<input name="zhuma" type="text" class="inputsmall" />(如:1245)</span><br />
			<span>倍数:<input name="beishu" type="text" class="inputsmall" />(最多50倍)</span><br />
			<span>追号:<input name="addNumber" type="text" class="inputsmall" />期</span><br />
			(最高99期,默认追1期,即买当前期)
			</p>
