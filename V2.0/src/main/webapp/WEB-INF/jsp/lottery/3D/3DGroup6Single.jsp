...
<div class="main" >
	...
	<div class="touzhutext">
			...
			<form action="/w/handpay/lottery3DGroup6SingleBetDetail.jspa" method="post">
			<p>
			<span>数字:<input name="zhuma" type="text" class="inputsmall" maxlength="3" value="${zhuma }"/>(如:245)</span><br />
			...
			(最高99期,默认追1期,即买当前期)
			<input name="type" value="3DGroup6Sing" type="hidden"/>
			</p>
