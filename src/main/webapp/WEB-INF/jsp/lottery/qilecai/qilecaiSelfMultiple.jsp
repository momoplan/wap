...
<div class="main" >
	...
	<div class="touzhuCon">
		...
		<div class="touzhunav">
			<ul>
				...
				<li class="navover"><a href="/w/handpay/lotteryQiLeCaiSelfMultiple.jspa">复式自选</a></li>
	...
	<div class="touzhutext">
			<p>
				${deadline }<br />
				数字1-30任选8-16个，号码间无空格，小于10则补0.如02061320.)</p>
			<form action="/w/handpay/lotteryQiLeCaiSelfMultipleBetDetail.jspa" method="post">
			<p>
			<span>填写号码:
			...
			<input name="type" type="hidden" value="QiLeCaiSelfMultiple"/>
