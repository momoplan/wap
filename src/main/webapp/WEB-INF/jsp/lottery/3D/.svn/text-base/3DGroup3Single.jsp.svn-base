...
<div class="main" >
	...
	<div class="touzhuCon">
		...
		<div class="touzhunav">
			<ul>
				...
				<li class="navover"><a href="/w/handpay/lottery3DGroup3Single.jspa">组三单式</a></li>
	...
	<div class="touzhutext">
			...
			<form action="/w/handpay/lottery3DGroup3SingleBetDetail.jspa" method="post">
			<p>
			<span>出现2次的号码:<input name="zhuma2" type="text" class="inputsmall" maxlength="1" value="${zhuma2 }"/>(如:3)</span><br />
			<span>出现1次的号码:<input name="zhuma1" type="text" class="inputsmall" maxlength="1" value="${zhuma1 }"/>(如:2)</span><br />
			...
			(最高99期,默认追1期,即买当前期)
			<input name="type" type="hidden" value="3DGroup3Single">
			</p>
