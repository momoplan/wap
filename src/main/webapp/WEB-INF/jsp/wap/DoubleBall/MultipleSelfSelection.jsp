...
<body>
		...
		<a href="/w/wap/DoubleBall/SingleSelfSelection.jspx">单式自选</a>|复式自选|<a href="/wap/DoubleBall/DantuoSelfSelection.jspx">胆拖自选</a><br/>
			红复式:<br/>可选7-20个红球和1个蓝球<br/>
			蓝复式:<br/>可选6个红球和2-16蓝球<br/>
			红蓝复式:<br/>可选7-20个红球和2-16个蓝球<br/>
			<%if (deadline!=null) { %>
			...
			%></a>
			<form action="<%=response.encodeURL(path+"/doubleballMultipleSelfSelection/showSelfBetDetails.jspx")%>" method="post" >
			红球:
			<input name="redNumbers" type="text" emptyok="false" maxlength="40" size="12" format="*N" value="<%=redNumbers %>" /><br/>(如:010212152233)<br/>
			蓝球:
			<input name="blueNumbers" type="text" emptyok="false" maxlength="32" size="12" format="*N" value="<%=blueNumbers %>" /><br/>(如:0708)<br/>
