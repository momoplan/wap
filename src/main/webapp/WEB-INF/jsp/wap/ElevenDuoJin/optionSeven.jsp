...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/ElevenDuoJin/optionOne.jspx">任一</a>|<a 
		   ...
		   自选|<a 
		   href="/w/wap/ElevenDuoJin/optionSevenAutoDS.jspx">单式机选</a>|<a 
		   href="/w/wap/ElevenDuoJin/optionSevenAutoFS.jspx">复式机选</a><br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
		<form action="/wap/ElevenDuoJin/optionSeven.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
		 
 		从1~11选择,注数≥7，号码间无分隔符,10之前号码前面补0,如1要输入01<br/>
 	 <%if(message != null){ %>
 ...
 <%} %>
	...
	<input type="hidden" name="type" value="R7">
