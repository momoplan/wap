...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		任一|<a 
		  ...
		  <a 
		   href= "/w/wap/ElevenDuoJin/optionOne.jspx">自选</a>|单式机选|<a 
		   href="/w/wap/ElevenDuoJin/optionOneAutoFS.jspx">复式机选</a><br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/ElevenDuoJin/optionOneAutoDS.jspx" method="post">
