...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/ElevenDuoJin/optionOne.jspx">任一</a>|<a 
		   ...
		   <a 
		   href= "/w/wap/ElevenDuoJin/optionThree.jspx">自选</a>|单式机选|<a 
		   href="/w/wap/ElevenDuoJin/optionThreeAutoFS.jspx">复式机选</a><br/>
		<%
		...
		%> <%
 		...
 		<form action="/wap/ElevenDuoJin/optionThreeAutoDS.jspx" method="post">
