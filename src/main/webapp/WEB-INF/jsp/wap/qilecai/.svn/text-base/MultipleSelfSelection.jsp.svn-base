...
<title>七乐彩复式自选</title>
	<body>
		...
		<a href="/wap/qilecai/SingleSelfSelection.jspx">单式自选</a>|复式自选|<a href="/wap/qilecai/DantuoSelfSelection.jspx">胆拖自选</a><br/>
			...
			<% if(message!=null){
			   ...
			   (数字1-30任选8-16个，号码间无空格，小于10则补0。如02061320)<br/>
			填写号码:<br/>
