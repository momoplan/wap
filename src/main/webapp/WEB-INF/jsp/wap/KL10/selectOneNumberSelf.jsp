...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		前一数投|<a 
		 ...
		 自选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneNumberSingleAuto.jspx">单式机选</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneNumberMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectOneNumberSelf.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
		  
 	从1~18选择，注码个数≥1，号码间无分隔符,10之前号码前面补0,如1要输入01<br/>
	...
	注码: <input type="text" name="zhuMa"  maxlength="36" size="20" value="${zhuMa }"><br/>
