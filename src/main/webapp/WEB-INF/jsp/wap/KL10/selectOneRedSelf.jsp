...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		 ...
		 自选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneRedSingleAuto.jspx">单式机选</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneRedMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectOneRedSelf.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
		  
 	从19~20选择，注码个数≥1，号码间无分隔符<br/>
	...
	注码: <input type="text" name="zhuMa"  maxlength="4" size="20" value="${zhuMa }"><br/>
