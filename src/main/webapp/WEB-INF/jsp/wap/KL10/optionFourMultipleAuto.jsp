...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		 ...
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/optionFourSelf.jspx">自选</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/optionFourSingleAuto.jspx">单式机选</a>|复式机选<br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/optionFourMultipleAuto.jspx" method="post">
	...
	机选: <input type="text" name="geShu"  maxlength="2" size="2" value="${geShu }">个(5-20)<br/>
