...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		自选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectTwoLinkDirectSingleAuto.jspx">单式机选</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectTwoLinkDirectMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectTwoLinkDirectSelf.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
	从1~20选择，每一位注码个数≥1，号码间无分隔符,10之前号码前面补0,如1<br/>	  
 	<c:if test="${not empty messageError }">
 		提示信息：<span style="color: red;"> ${messageError }</span><br/>
 	</c:if>

	<form action="/guangDongHappyTenMinutes/selectTwoLinkDirectSelfDetail.jspx" method="post">
