...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		 ...
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneRedSelf.jspx">自选</a>|单式机选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectOneRedMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectOneRedSingleAuto.jspx" method="post">
	...
	机选: <input type="text" name="zhuShu"  maxlength="2" size="2" value="${zhuShu }">注(最多2注)<br/>
