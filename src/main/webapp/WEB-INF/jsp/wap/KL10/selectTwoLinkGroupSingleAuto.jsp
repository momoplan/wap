...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		选二连组|<a 
		 ...
		 <a 
		   href="/w/guangDongHappyTenMinutesIndex/selectTwoLinkGroupSelf.jspx">自选</a>|单式机选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/selectTwoLinkGroupMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectTwoLinkGroupSingleAuto.jspx" method="post">
