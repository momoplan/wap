...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		前一数投|<a 
		 ...
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/selectOneNumberMultipleAuto.jspx" method="post">
	...
	机选: <input type="text" name="geShu"  maxlength="2" size="2" value="${geShu }">个(2-18)<br/>
