...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东快乐十分<br/>
		...
		<a 
		 ...
		 自选|<a 
		   href="/w/guangDongHappyTenMinutesIndex/optionFiveSingleAuto.jspx">单式机选</a>|<a 
		   href="/w/guangDongHappyTenMinutesIndex/optionFiveMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongHappyTenMinutesIndex/optionFiveSelf.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
		  
 	从1~20选择，注码个数≥5，号码间无分隔符,10之前号码前面补0,如1要输入01<br/>
