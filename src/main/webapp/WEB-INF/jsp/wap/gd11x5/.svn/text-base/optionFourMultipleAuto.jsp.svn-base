...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		...
		<a 
		 ...
		 <a 
		   href="/w/guangDongElevenSelectFiveIndex/optionFourSelf.jspx">自选</a>|<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionFourSingleAuto.jspx">单式机选</a>|复式机选<br/>
		${headLine }
 		<form action="/guangDongElevenSelectFiveIndex/optionFourMultipleAuto.jspx" method="post">
	...
	<c:if test="${not empty messageError }">
		...
		机选: <input name="geShu" type="text"  size="10" maxlength="2"  tabindex="1" value="${geShu }" />个(4-11)<br/>
