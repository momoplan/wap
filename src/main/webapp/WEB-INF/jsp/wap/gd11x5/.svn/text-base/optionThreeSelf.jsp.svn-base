...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		任选|<a 
		   ...
		   href="/w/guangDongElevenSelectFiveIndex/optionTwoDanTuoSelfoSelf.jspx">胆拖</a><br/>
		<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionOneSelf.jspx">一</a>|<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionTwoSelf.jspx">二</a>|三|<a 
		 ...
		 自选|<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionThreeSingleAuto.jspx">单式机选</a>|<a 
		   href="/w/guangDongElevenSelectFiveIndex/optionThreeMultipleAuto.jspx">复式机选</a><br/>
		 ${headLine }
 		<form action="/guangDongElevenSelectFiveIndex/optionThreeSelf.jspx" method="post">
 		<input type="submit" value="刷新" />
 		</form><br />
		  
 	从1~11选择,注数≥3，号码间无分隔符,10之前号码前面补0,如1要输入01<br/>
