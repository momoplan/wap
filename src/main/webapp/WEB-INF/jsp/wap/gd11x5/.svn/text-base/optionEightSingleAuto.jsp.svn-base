...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		...
		<a 
		 ...
		 <a 
		   href="/w/guangDongElevenSelectFiveIndex/optionEightSelf.jspx">自选</a>|单式机选<br/>
		 ${headLine }
 		<form action="/w/guangDongElevenSelectFiveIndex/optionEightSingleAuto.jspx" method="post">
