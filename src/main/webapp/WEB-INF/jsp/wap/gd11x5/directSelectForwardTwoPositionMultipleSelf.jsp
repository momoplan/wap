...
<a href="/w/wap/wapindex.jspx">首页</a>-<a href="/w/wap/buyLottery.jspx">购彩大厅</a>-广东11选5<br/>
		...
		选前二：<a 
		   href="/w/guangDongElevenSelectFiveIndex/directSelectForwardTwoSingleSelf.jspx">直选单式</a>|直选定位复式<br/>
		...
		${headLine }
 		<form action="/guangDongElevenSelectFiveIndex/directSelectForwardTwoPositionMultipleSelf.jspx" method="post">
	...
	<c:if test="${not empty messageError }">
 		...
 		<form action="/guangDongElevenSelectFive/directSelectForwardTwoPositionMultipleSelfDetail.jspx" method="post">
