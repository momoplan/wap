...
<body>
		   ...
		   href="/w/wap/3D/3DDantuoMultiple.jspx">胆拖</a><br/>
			<a href="/wap/3D/3DGroup6Single.jspx">组6单式</a>|组6复式|<a href="/wap/3D/3DGroup6HeZhi.jspx">组6和值</a><br/>
			...
			<form action="<%=response.encodeURL(path+"/multiple3D/group6MultipleDetail.jspx")%>" method="post" >
			...
			<%} %>
				<input type="hidden" name="pageType" value="group6Multiple" />
