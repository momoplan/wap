...
<body>
		...
		<a href="/wap/3D/3DDirectSingle.jspx">直选投注</a>|直选和值|<a href="/wap/3D/3DSingleSelectSingleMultiple.jspx">直选包号</a><br/>
			 (0-27中选一个和值，如5)<br/>
			 <%if (deadline!=null) { %>
			...
			<%} %>
				<input type="hidden" name="pageType" value="directSelection" />
