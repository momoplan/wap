...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/11select5/optionOne.jspx">一</a>|<a href="/wap/11select5/optionTwo.jspx">二</a>|<a href="/wap/11select5/optionThree.jspx">三</a>|<a href="/wap/11select5/optionFour.jspx">四</a>|五|<a href="/wap/11select5/optionSix.jspx">六</a>|<a href="/wap/11select5/optionSeven.jspx">七</a>|<a href="/wap/11select5/optionEight.jspx">八</a><br/>
		自选|<a 
		   href="/w/wap/11select5/optionFiveAutoDS.jspx">单式机选</a>|<a 
		   href="/w/wap/11select5/optionFiveAutoFS.jspx">复式机选</a><br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/11select5/optionFive.jspx" method="post">
		...
		%></a>
 		01-11选5-10个数字,号码间无分隔,数字不可重复,小于10则补0,如选择2则填写02<br/>
 		自选<br/>
 		<form action="/11select5/optionByHand.jspx" method="post">
 		注码：<input name="zhuma" type="text" emptyok="true"  size="20" maxlength="20" format="*N" tabindex="1" value="<%=zhuma %>" /><br/>
 		...
 		<input type="hidden" name="type" value="R5" />
