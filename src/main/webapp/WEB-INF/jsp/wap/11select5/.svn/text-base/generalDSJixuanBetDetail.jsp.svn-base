...
<%
		    ...
		    String optionDS = (String)request.getAttribute("optionDS");
		    String R = (String)request.getAttribute("R");
		%>
	<title>江西11选5普通玩法单式机选投注确认</title>
<body>
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		%><%if(type.equals("R1")){%>
			...
			<a href="<%=response.encodeURL(path+"/wap/11select5/ForwardThreeZX.jspx")%>">前三组选</a>
		...
		您的投注:<br/>
		    ...
		    <input type="hidden" name="optionDS" value="<%=optionDS%>" />
