...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a 
		   href="/w/wap/11select5/optionTwo.jspx">自选</a>|<a 
		   href="/w/wap/11select5/optionTwoAutoDS.jspx">单式机选</a>|复式机选<br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/11select5/optionTwoAutoFS.jspx" method="post">
