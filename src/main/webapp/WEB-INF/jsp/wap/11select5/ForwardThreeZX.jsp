...
<%
    ...
    String threeDS ="";
    threeDS = (String)request.getAttribute("threeDS");
    if(threeDS ==null) threeDS="5";
    String err_msg = (String)request.getAttribute("err_msg");
%>
	<title>江西11选5前三直选</title>
<body>
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a href="/wap/11select5/ForwardTwoZX.jspx">前二直选</a>|前三直选<br/>
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/11select5/ForwardThreeZX.jspx" method="post">
		...
		%></a>
 		01-11选3-11个数字,三位之和不超过11,号码间无分隔,数字不可重复,小于10则补0,如选择2则填写02<br/>
 		自选<br/>
 		<form action="/11select5/qThreeByHand.jspx" method="post">
 		...
 		第三位：<input name="hundred" type="text" emptyok="true"  size="20" maxlength="20" format="*N" tabindex="1" value="<%=hundred %>" /><br/>
