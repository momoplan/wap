...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		前二组选|<a href="/wap/11select5/ForwardThreeGroup.jspx">前三组选</a><br/>
		<%
		...
		%> <%
 		...
 		%> <%
 			out.print(deadline);
 		%> <%}%>
 		<form action="/wap/11select5/ForwardTwoGroup.jspx" method="post">
		...
		%></a>
 		01-11选2-8个数字,号码间无分隔,数字不可重复,小于10则补0,如选择2则填写02<br/>
 		自选<br/>
 		<form action="/11select5/zTwoByHand.jspx" method="post">
