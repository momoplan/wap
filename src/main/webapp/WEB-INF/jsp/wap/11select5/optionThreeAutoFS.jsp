...
<a href="/wap/wapindex.jspx">首页</a>-<a href="<%=response.encodeURL(path+"/wap/buyLottery.jspx")%>"><%
		...
		<a 
		   href="/w/wap/11select5/optionThree.jspx">自选</a>|<a 
		   href="/w/wap/11select5/optionThreeAutoDS.jspx">单式机选</a>|复式机选<br/>
		<%
		...
		%> <%
 		...
 		<form action="/wap/11select5/optionThreeAutoFS.jspx" method="post">
		...
		<input type="hidden" name="method" value="optionFSAuto" />
